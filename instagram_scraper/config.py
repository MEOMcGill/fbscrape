...
my_config_file = os.path.join(HOME_DIR, "meo_instagram_scraper_config.cfg")
...
USERNAME_1 = config["instagram-login"]["username-1"]
PASSWORD_1 = config["instagram-login"]["password-1"]
